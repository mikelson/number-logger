A simple and quick way to keep track of numeric values over time.

Examples of data to record:
  - water meter reading
  - temperature in the garden
  - number of crows at the feeder
  - blood pressure for person A, B

Each recorded number gets its time stamp from the clock.

The display shows the time and value in a simple list.

Your data are saved in your browser on your phone or PC. When you open
the page again from the same device, you should see your numbers again,
but not if you use a different device.

[Try it!](http://frombits.com/numberlogger/)
